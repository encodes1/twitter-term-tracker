<div class="">
    ...
    <h3>
        <a name="-024-all-the-basic-stuff" class="anchor" href="https://github.com/sandy98/node-simple-router#-024-all-the-basic-stuff"><span class="octicon octicon-link"></span></a>&lt; 0.2.4 All the basic stuff</h3>

    <h3>
        <a name="2012-09-07-v024-added-cgi-support" class="anchor" href="https://github.com/sandy98/node-simple-router#2012-09-07-v024-added-cgi-support"><span class="octicon octicon-link"></span></a>2012-09-07: v0.2.4 Added CGI support</h3>
    ...
    <div class="highlight highlight-python"><pre><span class="kn">import</span> <span class="nn">json</span><span class="o">,</span> <span class="nn">sys</span>
...
<span class="k">for</span> <span class="n">key</span> <span class="ow">in</span> <span class="n">body</span><span class="p">:</span>
    ...
    <h3>
        <a name="2013-03-25-v025-added-mimetypes-xml-and-svg-to-the-list-of-recognized-types" class="anchor" href="https://github.com/sandy98/node-simple-router#2013-03-25-v025-added-mimetypes-xml-and-svg-to-the-list-of-recognized-types"><span class="octicon octicon-link"></span></a>2013-03-25: v0.2.5 Added mimetypes xml and svg to the list of recognized types</h3>

    <h3>
        <a name="2013-04-01-v026-added-compile-to-js-tool-compilesh" class="anchor" href="https://github.com/sandy98/node-simple-router#2013-04-01-v026-added-compile-to-js-tool-compilesh"><span class="octicon octicon-link"></span></a>2013-04-01: v0.2.6 Added compile to js tool 'compile.sh'</h3>

    <h3>
        <a name="2013-04-02-v027-added-mk-server-to-the-bin-directory" class="anchor" href="https://github.com/sandy98/node-simple-router#2013-04-02-v027-added-mk-server-to-the-bin-directory"><span class="octicon octicon-link"></span></a>2013-04-02: v0.2.7 Added mk-server to the bin directory.</h3>
    ...
    <h3>
        <a name="2013-04-03-v030-node-simple-router-becomes-able-to-handle-form-uploads" class="anchor" href="https://github.com/sandy98/node-simple-router#2013-04-03-v030-node-simple-router-becomes-able-to-handle-form-uploads"><span class="octicon octicon-link"></span></a>2013-04-03: v0.3.0 node-simple-router becomes able to handle form uploads.</h3>
  ...
  <span class="nx">res</span><span class="p">.</span><span class="nx">end</span> <span class="s">""</span>
    ...
    <a name="2013-07-27-v035-correction-for-paths-which-have-escaped-characters" class="anchor" href="https://github.com/sandy98/node-simple-router#2013-07-27-v035-correction-for-paths-which-have-escaped-characters"><span class="octicon octicon-link"></span></a>2013-07-27: v0.3.5 Correction for paths which have escaped characters.</h3>

    <h3>
        <a name="2013-08-02-v036-added-default-favicon-fixed-cgi-bin" class="anchor" href="https://github.com/sandy98/node-simple-router#2013-08-02-v036-added-default-favicon-fixed-cgi-bin"><span class="octicon octicon-link"></span></a>2013-08-02: v0.3.6 Added default favicon. Fixed cgi-bin.</h3>

    <h3>
        <a name="2013-08-03-v041-improved-cgi-bin-looks-like-its-now-really-usable-now-fcgi-to-come" class="anchor" href="https://github.com/sandy98/node-simple-router#2013-08-03-v041-improved-cgi-bin-looks-like-its-now-really-usable-now-fcgi-to-come"><span class="octicon octicon-link"></span></a>2013-08-03: v0.4.1 Improved cgi-bin. Looks like it's now really usable. Now FCGI to come.</h3>

    <h3>
        <a name="2013-08-04-v045-further-improvement-for-cgi-bin-mainly-php-related-some-issues-remain-as-regards-to-php-though" class="anchor" href="https://github.com/sandy98/node-simple-router#2013-08-04-v045-further-improvement-for-cgi-bin-mainly-php-related-some-issues-remain-as-regards-to-php-though"><span class="octicon octicon-link"></span></a>2013-08-04: v0.4.5 Further improvement for cgi-bin, mainly PHP related. Some issues remain as regards to PHP, though.</h3>

    <h3>
        <a name="2013-08-12-v047-cgi-works-smoothly-now-scgi-support---routerscgi_pass---added-and-working-fine" class="anchor" href="https://github.com/sandy98/node-simple-router#2013-08-12-v047-cgi-works-smoothly-now-scgi-support---routerscgi_pass---added-and-working-fine"><span class="octicon octicon-link"></span></a>2013-08-12: v0.4.7 CGI works smoothly now. SCGI support - router.scgi_pass - added and working fine.</h3>

    <h3>
        <a name="2013-12-28-v049-2-fixes-nil-error-when-request-method-is-not-knownhandled" class="anchor" href="https://github.com/sandy98/node-simple-router#2013-12-28-v049-2-fixes-nil-error-when-request-method-is-not-knownhandled"><span class="octicon octicon-link"></span></a>2013-12-28: v0.4.9-2 Fixes nil error when request method is not known/handled.</h3>

    <h3>
        <a name="2013-12-29-v049-3-as-a-result-of-the-former-now-nsr-handles-routerany-for-example" class="anchor" href="https://github.com/sandy98/node-simple-router#2013-12-29-v049-3-as-a-result-of-the-former-now-nsr-handles-routerany-for-example"><span class="octicon octicon-link"></span></a>2013-12-29: v0.4.9-3 As a result of the former, now NSR handles <em>router.any</em>, for example:</h3>
    ...
    <h3>
        <a name="2014-01-10-v049-4-improved-server-generated-by-mk-server-utility" class="anchor" href="https://github.com/sandy98/node-simple-router#2014-01-10-v049-4-improved-server-generated-by-mk-server-utility"><span class="octicon octicon-link"></span></a>2014-01-10: v0.4.9-4 Improved server generated by mk-server utility.</h3>
